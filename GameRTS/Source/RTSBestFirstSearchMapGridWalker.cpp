...
template<typename T>
bool RTSBestFirstSearchMapGridWalker::existsInList(RTSMapTileNode* n, T list)
{
...
void RTSBestFirstSearchMapGridWalker::visitAdjacent(int32 _x, int32 _y, int32 x, int32 y)
{
...
void RTSBestFirstSearchMapGridWalker::reparentNode(RTSMapTileNode* n, RTSMapTileNode* parent)
{
  n->setParent(parent);
}
